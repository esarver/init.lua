return {
    ...
    config = function()
        ...
        local Esarver_Fugitive = vim.api.nvim_create_augroup("Esarver_Fugitive", {})

        local autocmd = vim.api.nvim_create_autocmd
        autocmd("BufWinEnter", {
            group = Esarver_Fugitive,
            pattern = "*",
            callback = function()
                ...
                vim.keymap.set("n", "<leader>t", ":Git push -u origin ", {buffer = bufnr, remap = false, desc="Fugitive: Publish Branch"});
            end,
        })
